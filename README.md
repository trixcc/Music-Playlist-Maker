...
- As a user, I want to be able to see how many songs are in my playlist.
- As a user, I want to be able to select a song from a playlist and view its details.
    - The details of a song include the title of the song, the artist's name, the album name, the link?
